		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveTbstuday.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sdhobby1" name="sdhobby" value="篮球" aria-required="true" required/>篮球
									<input type="checkbox" id="sdhobby2" name="sdhobby" value="足球" aria-required="true" required/>足球
									<input type="checkbox" id="sdhobby3" name="sdhobby" value="琴棋书画" aria-required="true" required/>琴棋书画</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
								<td><input type="date" id="sdbirh" name="sdbirh" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>学生专业：</td>
								<td colspan="4">
...
/* 	            username: $("#txt_search_username").val(), */
	...
	function initEditUser(getSelection){
		...
		$('#sdhobby3').prop("checked",getSelection.sdhobby.indexOf("琴棋书画")!=-1);
		$('#sdbirh').val(new Date(getSelection.sdbirh).Format("yyyy-MM-dd"))
	}
